        ...
        <table class="table table-striped table-bordered table-hover">
            <tbody>
                <tr class="form-inline">
                    ...
                    <td>
                        <select class="form-control w200" name="mamon" id="subject" onchange="change_subject()">
               ...
               <tr class="form-inline">
                ...
                <tr>
                    ...
                    <td>
                        <input disabled class="form-control w400" name="tietppct" type="text" value="{DATA.tietppct}" maxlength="255" id="lesson_number"/>
                    </td>
                </tr>
                ...
                <tr class="form-inline">
                    ...
                    <td>
                        <select class="form-control w400 selectpicker" name="hocsinhvang[]" multiple data-live-search="true">
								<option value="0" {DATA_STUDENT.selected}>Chọn học sinh vắng</option>
                                <!-- BEGIN: loopstudent -->
                                <option value="{DATA_STUDENT.key}" {DATA_STUDENT.selected}>{DATA_STUDENT.title}</option>
                                <!-- END: loopstudent -->
                        </select>
                    </td>
                </tr>
                ...
                <tr>
                    <td>{LANG.comment}</td>
                    <td>
                    <textarea class="form-control w400" name="nhanxet"  rows="4" cols="50">{DATA.nhanxet}</textarea>
                    </td>
                </tr>
                ...
                <tr class="form-inline">
                    ...
                    <td>
                        ...
                        <input class="form-control w100" name="diemhoctap" type="text" value="{DATA.diemhoctap}" maxlength="255" />
                        {LANG.discipline} <span class="red">*</span>
                        <input class="form-control w100" name="diemkyluat" type="text" value="{DATA.diemkyluat}" maxlength="255" />
                        {LANG.clean} <span class="red">*</span>
                        <input class="form-control w100" name="diemvesinh" type="text" value="{DATA.diemvesinh}" maxlength="255" />
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                    <input class="form-control w400 pull-left" style="margin-right: 5px" name="giaovienbmkiten" id="anhdaidien" type="text" value="{DATA.giaovienbmkiten}" maxlength="255" />
